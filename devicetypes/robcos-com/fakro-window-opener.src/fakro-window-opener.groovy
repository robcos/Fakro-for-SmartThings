 ...
 */
metadata {
	definition (name: "Fakro Window Opener", namespace: "robcos.com", author: "Roberto Cosenza", ocfDeviceType: "oic.d.garagedoor") {
		capability "Switch"
        capability "Actuator"
...
def open() {
    ...
    def result = []
  	result << createEvent(name: "contact", value: "opening", displayed: false)
    result << createEvent(name: "door", value: "opening", displayed: false)
	setLevel(255)    
  //  result
}
...
def close() {
    ...
    def result = []
  	result << createEvent(name: "contact", value: "closing", displayed: false)
    result << createEvent(name: "door", value: "closing", displayed: false)
	setLevel(0)    
  //  result
}
...
//	delayBetween ([zwave.basicV1.basicSet(value: level).format(), zwave.switchMultilevelV1.switchMultilevelGet().format()], 35000)
//	delayBetween ([zwave.basicV1.basicSet(value: level).format(), zwave.switchBinaryV1.switchBinaryGet().format()], 5000) 
	delayBetween ([
    zwave.basicV1.basicSet(value: level).format(), 
//	zwave.powerlevelV1.powerlevelGet().format(),
//	zwave.sensorMultilevelV2.sensorMultilevelGet().format(),
//  zwave.switchToggleBinaryV1.switchToggleBinaryGet().format(),
